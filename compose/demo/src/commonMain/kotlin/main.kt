...
fun main() = singleWindowApplication(
    ...
    MaterialTheme(
        ...
        Scaffold(
            topBar = {
                TopAppBar(
                    title = { Text("${if (isKodein) "Kodein" else "Default"} ${if (isDark) "Dark" else "Light"} Theme") },
                    actions = {
                        IconButton(
...
@Composable
fun NameAndColor(name: String, color: Color, onColor: Color, modifier: Modifier = Modifier) {
    Surface(
        color = color,
