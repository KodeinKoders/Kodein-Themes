...
public val JetBrainsMonoNL: FontFamily @Composable get() = FontFamily(
    ...
    Font(resource = Res.font.JetBrainsMonoNL_Normal, weight = FontWeight.Normal, style = FontStyle.Normal),
    Font(resource = Res.font.JetBrainsMonoNL_NormalItalic, weight = FontWeight.Normal, style = FontStyle.Italic),
