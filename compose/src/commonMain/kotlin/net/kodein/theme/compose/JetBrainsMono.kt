...
public val JetBrainsMono: FontFamily @Composable get() = FontFamily(
    ...
    Font(resource = Res.font.JetBrainsMono_Normal, weight = FontWeight.Normal, style = FontStyle.Normal),
    Font(resource = Res.font.JetBrainsMono_NormalItalic, weight = FontWeight.Normal, style = FontStyle.Italic),
